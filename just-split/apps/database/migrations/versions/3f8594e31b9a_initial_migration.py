...
Revision ID: 3f8594e31b9a
Revises: 
Create Date: 2023-09-03 21:05:07.647613
...
def upgrade():
    ...
    sa.Column('current_currency', sa.String(length=50), nullable=True, unique=True),
    ...
    sa.Column('expense_currency', sa.String(50), nullable=True),
